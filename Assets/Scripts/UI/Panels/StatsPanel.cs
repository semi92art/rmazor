...
namespace UI.Panels
{
    public interface IStatsPanel : IMiniPanel
    {
    ...
    public class StatsPanel : IStatsPanel
    {
        ...
        private StatsPanel(RectTransform _Parent, StatsPanelPosition _Position)
        {
        ...
        public static IStatsPanel Create(RectTransform _Parent, StatsPanelPosition _Position)
        {
            return new StatsPanel(_Parent, _Position);
        }
