...
{
    public class GooglePlayGamesRemoteRemoteSavedGameProvider : RemoteRemoteSavedGameProviderBase, IUpdateTick
    {
        #region types
        ...
        private GooglePlayGamesRemoteRemoteSavedGameProvider(IViewGameTicker _Ticker)
        {
            Ticker = _Ticker;
        }
        ...
        ~GooglePlayGamesRemoteRemoteSavedGameProvider()
        {
