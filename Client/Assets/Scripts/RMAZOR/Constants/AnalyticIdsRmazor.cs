namespace RMAZOR.Constants
{
    public class AnalyticIdsRmazor
    {
        ...
        public const string LevelsButtonPressed                = "levels_button_pressed";
        public const string DailyGiftButtonPressed             = "daily_gift_button_pressed";
        public const string DisableAdsMainButtonPressed        = "disable_ads_main_button_pressed";
        public const string RateGameMainButtonPressed          = "rate_game_main_button_pressed";
