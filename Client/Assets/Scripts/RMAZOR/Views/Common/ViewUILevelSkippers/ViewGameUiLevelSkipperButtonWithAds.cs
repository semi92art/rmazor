...
{
    public class ViewGameUiLevelSkipperButtonWithAds : ViewGameUiLevelSkipperButtonBase
    {
        ...
        private ViewGameUiLevelSkipperButtonWithAds(
        ...
        protected override void OnActiveCameraChanged(Camera _Camera)
        {
            ...
            {
                ComInComArg.ParameterLevelTypeDefault => yPos - 8f,
                ComInComArg.ParameterLevelTypeBonus   => yPos - 4f,
                _                                     => yPos
            };
