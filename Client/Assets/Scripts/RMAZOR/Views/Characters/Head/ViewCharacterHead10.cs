...
{
    public interface IViewCharacterHead10 : IViewCharacterHead { }

    public class ViewCharacterHead10 
        : ViewCharacterHeadWithBorderObjectBase,
          IViewCharacterHead10
    {
        ...
        protected override void InitPrefab()
        {
            ...
            m_Ear1Body = go.GetCompItem<Triangle>("ear_1_body").SetSortingOrder(sOrder);
            m_Ear2Body    = go.GetCompItem<Triangle>("ear_2_body").SetSortingOrder(sOrder);
            m_Ear1Border1 = go.GetCompItem<Line>("ear_1_border_1").SetSortingOrder(sOrder + 1);
            m_Ear1Border2 = go.GetCompItem<Line>("ear_1_border_2").SetSortingOrder(sOrder + 1);
            m_Ear2Border1 = go.GetCompItem<Line>("ear_2_border_1").SetSortingOrder(sOrder + 1);
            m_Ear2Border2 = go.GetCompItem<Line>("ear_2_border_2").SetSortingOrder(sOrder + 1);
        }
