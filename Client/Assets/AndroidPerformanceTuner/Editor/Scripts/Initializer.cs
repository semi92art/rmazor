...
namespace Google.Android.PerformanceTuner.Editor
{
    ...
    public class Initializer : AssetPostprocessor
    {
        ...
        static void Init()
        {
            ...
            // FIXME этот ебаный код сука стирает нахуй мои символы, пошел она нахуй
            ...
            var scriptDefSymbols = GetScriptingDefineSymbols(NamedBuildTarget.Android);
            if (!scriptDefSymbols.Contains(Paths.utilitiesScriptingSymbol))
                scriptDefSymbols.Add(Paths.utilitiesScriptingSymbol);
            PlayerSettings.SetScriptingDefineSymbols(NamedBuildTarget.Android, scriptDefSymbols.ToArray());
